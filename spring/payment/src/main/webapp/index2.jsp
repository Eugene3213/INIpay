...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <% 
 		...
 		String m4 = "memail";
 		/*
 		String mid1 = (String)session.getAttribute(m1);
 		String mname2 = (String)session.getAttribute(m2);
 		String mtel3 =(String)session.getAttribute(m3);
 		String memail4 =(String)session.getAttribute(m4); */
...
<title>결제자 정보 확인 및 배송 정보 확인 페이지</title>
	...
	<body>
	<form action="" name="frm" id="frm" enctype="application/x-www-form-urlencoded">
		<!-- PG사에 제공되는 hidden 값들  -->
	...
	<script type="module">
		var money =<%=pd_money%>;
		import { gopayment} from "./js/index.js?v=1";
