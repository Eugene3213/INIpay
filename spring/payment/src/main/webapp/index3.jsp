...
<form action="" name="pay" id="pay">
	...
	<input type="hidden" name="returnUrl" value="http://parkyj3089.cafe24.com/payment/INIstdpay_pc_return.jsp">
	<input type="hidden" name="closeUrl" value="http://parkyj3089.cafe24.com/payment/close.jsp">
